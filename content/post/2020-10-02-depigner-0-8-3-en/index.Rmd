...
-   Now `paired_test_categorical()` can works with matrices too, and not only with data frames. Moreover, a bug is fixed that prevent the function to work when a value from one group to another pass from a zero value to a non zero value.

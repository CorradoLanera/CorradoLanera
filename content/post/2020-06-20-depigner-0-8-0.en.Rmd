...
I’m very exited to announce the initial release of `{depigner}` to
CRAN!
...
hope is to provide solutions to that kind of problems which would be
normally solved using quick-and-dirty (ugly and maybe even wrong)
patches.
...
If you would like to by updated with the last development version 
...
# Acknowledgements 
The `{depigner}`'s logo was designed by

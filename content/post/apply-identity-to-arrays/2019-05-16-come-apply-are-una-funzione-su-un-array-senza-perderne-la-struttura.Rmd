---
title: "apply()are una funzione lungo una dimensione di un array, senza perderne la struttura"
...
Hadley Wickham sugegrisce di usare `pryr::aapern()`. proviamo a vedere 
...
quindi di ottenre in output lo stesso identico oggetto, cosa che non
...
a cui è stata assegnato un attributo **dim**; nel caso in cui **dim**
sia di lunghezza $2$, verrà chiamata
...
R** (@wickham2019advanced) sappiamo che sottoselezionare un oggetto con
...
Ri-puffRbacco! Qui la situazione sembra adirittura invertita,
arrivando al risultato che immaginiamo nel primo caso ma non negli
altri. Inoltre pare che i risultati siano propio differenti rispetto 
...
sono poi riarrangiati in matrici $3x3$ ("lungo" la seconda e terza
...
ri-distribuiti in una matrice, la prima e seconda dimensione dell'array

...
birth_foreveryoung <- foreveryoung %>% 
  mutate(
    data_of_birth = today() - years(computed_age)
  )
...
sembra essere molto lontano da quanto atteso. Immaginare che il tutto 
possa essere incluso in uno script di cui questo non è che un risultato
intermedio, che magari non verrà nemmeno mai visualizzato, porta a
disegnare scenari variabili dall'imbarazzante al problematico.
